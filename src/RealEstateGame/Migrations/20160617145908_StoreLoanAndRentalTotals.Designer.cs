...
namespace RealEstateGame.Migrations
{
    ...
    [Migration("20160617145908_StoreLoanAndRentalTotals")]
    partial class StoreLoanAndRentalTotals
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("RealEstateGame.Models.Home", b =>
                {
                    ...
                    b.Property<int?>("loanLoanId");

                    b.Property<int?>("renterRenterId");
            ...
            modelBuilder.Entity("RealEstateGame.Models.Home", b =>
                {
                    b.HasOne("RealEstateGame.Models.Loan")
                        .WithMany()
                        .HasForeignKey("loanLoanId");

                    b.HasOne("RealEstateGame.Models.Renter")
                        .WithMany()
                        .HasForeignKey("renterRenterId");
                });
        }
    }
}
